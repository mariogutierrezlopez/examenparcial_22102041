...
class Servidor(): #Creo una clase en vez de una función, no puedo llamarla más adelante
    ...
    def __init__(self, host=socket.gethostname(), port=int(input("Que puerto quiere usar ? "))):
        ...
        # CREO LAS DIMENSIONES DE LAS VARIALES QUE VOY A ENVIAR AL SOCKET SERVER
        self.n_fil_A = 2041 # Últimas 4 cifras del nº de expediente
        self.n_col_A = 22 # Primeras 2 cifras del nº de expediente
        self.n_fil_B = 22 # Primeras 2 cifras del nº de expediente
        self.n_col_B = 2041 # Últimas 4 cifras del nº de expediente
    ...
    def aceptarC(self):
        ...
        while True:
            try:
                ...
                self.readNick()
                conn.send(pickle.dumps(str(self.n_fil_A) + ";" + str(self.n_col_A) + ";"+str(self.n_fil_B) + ";"+str(self.n_col_B) + ";"))
